...
export const Contacts: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const items = Array.from(containerRef.current.querySelectorAll<HTMLElement>("[data-anim-item]"));
    ...
    <div className={styles.contact} ref={containerRef}>
      <form name="feedback" onSubmit={handleFormSubmit}>
        ...
        <p className={cx(styles.contact__item, styles["contact__item--right"])} data-anim-item>
          <button className={styles.btn} type="submit" disabled={status === "pending"}>
            Submit
          </button>
        </p>
